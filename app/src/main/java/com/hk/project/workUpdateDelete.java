   ...
   // private String[] jobList  = {"Job 1", "Job 2", "Job 3", "Job 4", "Job 5"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            int jobIndex = jobTitles.indexOf(job);
            if (jobIndex >= 0) {
    ...
    private void updateTimeField(EditText editText) {
        ...
        private void updateData(String updatedDescription, String updatedJob, String updatedDay, String updatedStartTime, String updatedEndTime, String updatedWorkingTime) {
            ...
            database.update(DatabaseHelper.TABLE_TIME_ENTRIES, values, selection, selectionArgs);
        ...
        private void deleteData() {
            ...
            database.delete(DatabaseHelper.TABLE_TIME_ENTRIES, selection, selectionArgs);
